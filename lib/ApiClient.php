...
class ApiClient
{
     ...
     */
    public function __construct(\eSagu\EBay\RePricing\V1\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \eSagu\EBay\RePricing\V1\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\eSagu\EBay\RePricing\V1\ObjectSerializer::sanitizeForSerialization($postData));
        }
