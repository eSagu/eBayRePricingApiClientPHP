...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.esagu.de/ebay/repricing/v1';
    ...
    {
        $report  = 'PHP SDK (eSagu\EBay\RePricing\V1) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
<<<<<<< HEAD
        $report .= '    OpenAPI Spec Version: 1.2.14' . PHP_EOL;
=======
